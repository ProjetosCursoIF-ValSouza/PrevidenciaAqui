...
class UserModel {
    ...
    async create() {
        try {
            ...
            const [rows, fields] = await pool.poolPrevAqui.query(sql, values);
    ...
    async delete() {
        try {
            ...
            const [rows, fields] = await pool.poolPrevAqui.query(sql, [this.id]);
    ...
    static async findById(id) {
        try {
            ...
            const [rows, fields] = await pool.poolPrevAqui.query(sql, [id]);
    ...
    static async findAll() {
        try {
            ...
            const [rows, fields] = await pool.poolPrevAqui.query(sql);
    ...
    static async findByUsernameOrEmail(usernameOrEmail) {
        try {
            ...
            const [rows, fields] = await pool.poolPrevAqui.query(sql, [usernameOrEmail, usernameOrEmail]);
